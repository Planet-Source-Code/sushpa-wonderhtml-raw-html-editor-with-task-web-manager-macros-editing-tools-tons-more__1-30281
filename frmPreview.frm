...
Begin VB.Form frmDocPreview 
   BackColor       =   &H80000004&
   Caption         =   "WonderHTML: Print Preview"
   ClientHeight    =   6540
   ClientLeft      =   1785
   ClientTop       =   2355
   ClientWidth     =   9690
...
Private Sub Form_Load()
    ...
    DocWYSIWYG frmMain.ActiveForm.rtfTmp
...
Sub FormPreviewPage(inControl As Control, InPage As Integer)
    ...
    TextLength = Len(frmMain.ActiveForm.rtfTmp.Text)

    PageCtn = 1
    Do
        newStartPos = SendMessage(frmMain.ActiveForm.rtfTmp.hwnd, EM_FORMATRANGE, True, mFormatRange)
...
Sub DocPrintProc()
    ...
    If frmMain.ActiveForm.rtfTmp.SelLength = 0 Then
