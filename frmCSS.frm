...
frmMain.ActiveForm.RTF1.SelStart = globalPos - 1
frmMain.ActiveForm.RTF1.SelLength = globalPos2 - globalPos
tmp = vbCrLf
...
pos = InStr(1, frmMain.ActiveForm.RTF1.Text, "<STYLE", vbTextCompare)
pos2 = InStr(pos + 1, frmMain.ActiveForm.RTF1.Text, "</STYLE>", vbTextCompare)
If pos2 = 0 And pos > 0 Then MsgBox "Invalid file format.", vbCritical: Unload Me: Exit Sub
If pos = 0 Then
pos = InStr(1, frmMain.ActiveForm.RTF1.Text, "<!--")
pos2 = InStr(pos + 1, frmMain.ActiveForm.RTF1.Text, "-->", vbTextCompare)
Else
pos = pos + InStr(pos + 1, frmMain.ActiveForm.RTF1.Text, ">") + 1
GoTo existing
End If
If pos = 0 Or pos2 = 0 Then MsgBox "Invalid file format.", vbCritical: Unload Me: Exit Sub
pos = pos + 4
pos2 = pos2 - 3
If pos <= 0 Or pos2 <= 0 Then MsgBox "Invalid file format.", vbCritical: Unload Me: Exit Sub
existing:
